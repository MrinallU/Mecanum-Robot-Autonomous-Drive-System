...
import static org.firstinspires.ftc.teamcode.Utils.RoadRunner.drive.DriveConstants.MAX_ANG_ACCEL;
import static org.firstinspires.ftc.teamcode.Utils.RoadRunner.drive.DriveConstants.MAX_ANG_VEL;
...
import static org.firstinspires.ftc.teamcode.Utils.RoadRunner.drive.DriveConstants.TRACK_WIDTH;
import static org.firstinspires.ftc.teamcode.Utils.RoadRunner.drive.DriveConstants.encoderTicksToInches;
 ...
 */
@Config
public class Tank extends TankDrive {
    public static PIDCoefficients AXIAL_PID = new PIDCoefficients(0.05, 0, 0);
    public static PIDCoefficients CROSS_TRACK_PID = new PIDCoefficients(1.8, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.44, 0, 0);
...
//         follower = new RamseteFollower(0, 0, new Pose2d(0.5, 0.5, Math.toRadians(5.0)));
        ...
        setLocalizer(new TankLocalizer(this, true));
