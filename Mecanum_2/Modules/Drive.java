...
public class Drive extends Base {
    ...
    public void traversePath(
        ...
        while ((lastLhInd < wp.size() - 1
            ...
            if(limitPower&&getRobotDistanceFromPoint(nxtP) > 6) {
                if (yPow < 0) {
    ...
    public void driveFieldCentric(double baseAngle, double drive, double turn, double strafe) {
        // Math for Field Centric 2.0: https://github.com/FTCLib/FTCLib/blob/master/core/src/main/java/com/arcrobotics/ftclib/drivebase/MecanumDrive.java
