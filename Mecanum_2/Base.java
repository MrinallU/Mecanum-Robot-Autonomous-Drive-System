...
public abstract class Base extends LinearOpMode {
  ...
  //    public void SplinePathSplineHeading(ArrayList<Point> pts, double driveSpeedCap, double
  // powLb, double xError,
  //                                          double yError, double angleError, int lookAheadDist,
  // double timeout){
  //        Point curLoc = dt.getCurrentPosition();
  //        ArrayList<Point> wps = PathGenerator.interpSplinePath(pts,  curLoc);
  //        dt.traversePath(wps, Double.MAX_VALUE , driveSpeedCap, powLb, xError, yError,
  // angleError, lookAheadDist, timeout);
  //    }
  ...
  //    public void LinearPathSplineHeading(ArrayList<Point> pts, double driveSpeedCap, double
  // powLb, double xError,
  //                                        double yError, double angleError, int lookAheadDist,
  // double timeout){
  //        Point curLoc = dt.getCurrentPosition();
